...
-- ---------------------------------------------------------------------
-- ⚠️ 배포 순서 주의: 운영은 "머지 순서 = 배포 순서"를 강제한다(out-of-order 비활성, SSM
-- FLYWAY_OUT_OF_ORDER=false). 이 시점(2026-08-11) 운영 RDS의 최신 적용 버전은 3.1.2로 develop
-- 브랜치보다 한참 뒤처져 있어 V4.5가 지금은 안전하지만, 만약 V7.x가 먼저 배포된 뒤에 이 PR이
-- 배포되면 V4.5가 out-of-order로 막힌다. 배포 전에 운영 flyway_schema_history를 다시 확인할 것.
--
