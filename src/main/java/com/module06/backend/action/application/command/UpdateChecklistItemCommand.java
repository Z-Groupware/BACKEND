...
/* comment.
    체크리스트 항목 수정 입력값을 application 계층으로 전달하는 명령 객체(FR-AC-05).
    담을 값: 항목 id · 변경할 내용(content) 또는 완료 여부(isDone).

    연결된 클래스
    - UpdateChecklistItemRequest : 이 명령으로 변환되는 요청 DTO (presentation)
